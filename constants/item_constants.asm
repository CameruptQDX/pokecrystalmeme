...
; - ItemEffects (see engine/items/item_effects.asm)
	...
	const MAX_REPEL    ; 2b
	const DIRE_HIT     ; 2c
	const GANLON_BERRY      ; 2d
	const FRESH_WATER  ; 2e
	const SODA_POP     ; 2f
	const LEMONADE     ; 30
	const X_ATTACK     ; 31
	const SALAC_BERRY      ; 32
	const X_DEFEND     ; 33
	const X_SPEED      ; 34
	const X_SPECIAL    ; 35
	const COIN_CASE    ; 36
	const ITEMFINDER   ; 37
	const PETAYA_BERRY   ; 38
	const EXP_SHARE    ; 39
	const OLD_ROD      ; 3a
	const GOOD_ROD     ; 3b
	...
	const WATERFALLER      ; b0
	const PARK_BALL    ; b1
	const RAINBOW_WING ; b2
	const ROBO_LAPRAS      ; b3
