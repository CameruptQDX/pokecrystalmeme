...
.VendItem:
	...
	writetext IlexClangText
	buttonsound
	itemnotify
	jump .Start

.NotEnoughMoney:
	writetext IlexVendingNoMoneyText
	waitbutton
	jump .Start

.NotEnoughSpace:
	writetext IlexVendingNoSpaceText
	waitbutton
	jump .Start
...
IlexVendingNoMoneyText:
	text "Oops, not enough"
	line "money…"
	done

IlexVendingNoSpaceText:
...
IlexForest_MapEvents:
	...
	warp_event 19, 48, ILEX_FOREST_AZALEA_GATE, 1
	warp_event 19, 49, ILEX_FOREST_AZALEA_GATE, 2
	...
	bg_event 21, 15, BGEVENT_ITEM, IlexForestHiddenSuperPotion
