...
RuinsOfAlphOutside_MapEvents:
	...
	object_event  2, 13, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, DesertGreatBall, EVENT_UNION_CAVE_1F_GREAT_BALL
	object_event  3, 31, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, DesertXAttack, EVENT_UNION_CAVE_1F_X_ATTACK
	object_event 10, 24, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, DesertPotion, EVENT_UNION_CAVE_1F_POTION
