...
GoldenrodCity_MapEvents:
	...
	warp_event  0,  0, GOLDENROD_MAGNET_TRAIN_STATION, 2
	...
	warp_event  4, 15, GOLDENROD_GAME_CORNER, 1
	warp_event 15, 17, RADIO_TOWER_1F, 1
	...
	db 12 ; bg events
	bg_event 34, 27, BGEVENT_READ, GoldenrodCityStationSign
	bg_event 16, 18, BGEVENT_READ, GoldenrodCityRadioTowerSign
	...
	bg_event  6, 16, BGEVENT_READ, GoldenrodCityGameCornerSign
	...
	bg_event 30,  7, BGEVENT_READ, GoldenrodCityFlowerShopSign

	db 15 ; object events
	object_event 10, 17, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityPokefanMScript, EVENT_GOLDENROD_CITY_CIVILIANS
	...
	object_event 14, 20, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, GoldenrodCityCooltrainerF1Script, EVENT_GOLDENROD_CITY_CIVILIANS
	...
	object_event  3, 16, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocketScoutScript, EVENT_GOLDENROD_CITY_ROCKET_SCOUT
	...
	object_event 15, 18, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket3Script, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	...
	object_event 10, 22, SPRITE_POKEFAN_M, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, MoveTutorScript, EVENT_GOLDENROD_CITY_MOVE_TUTOR
