...
GoldenrodCity_MapEvents:
	...
	warp_event 15, 21, RADIO_TOWER_1F, 1
	...
	bg_event 16, 22, BGEVENT_READ, GoldenrodCityRadioTowerSign
	...
	object_event 15, 22, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket3Script, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
