; Pack.Jumptable and BattlePack.Jumptable indexes
	...
	const PACKSTATE_INITGEARPOCKET
	const PACKSTATE_GEARPOCKETMENU
...
.KeyItemsPocketMenu:
	...
	ld b, PACKSTATE_INITGEARPOCKET ; left
...
.BerryPocketMenu:
	...
	ld c, PACKSTATE_INITGEARPOCKET ; right
	call Pack_InterpretJoypad
	ret c
	call .ItemBallsKey_LoadSubmenu
	ret
...
.GearPocketMenu:
	ld hl, GearPocketMenuHeader
	call CopyMenuHeader
	ld a, [wGearPocketCursor]
	ld [wMenuCursorBuffer], a
	ld a, [wGearPocketScrollPosition]
	ld [wMenuScrollPosition], a
	call ScrollingMenu
	ld a, [wMenuScrollPosition]
	ld [wBerryPocketScrollPosition], a
	ld a, [wMenuCursorY]
	ld [wGearPocketCursor], a
...
.GearPocketMenu:
	...
	call ScrollingMenu
	ld a, [wMenuScrollPosition]
	ld [wGearPocketScrollPosition], a
	ld a, [wMenuCursorY]
	ld [wGearPocketCursor], a
	ld b, PACKSTATE_INITBERRYPOCKET ; left
	ld c, PACKSTATE_INITKEYITEMSPOCKET ; right
...
.GearPocket:
	ld a, GEAR_POCKET
	call InitPocket
	ld hl, PC_Mart_GearPocketMenuHeader
	call CopyMenuHeader
	ld a, [wGearPocketCursor]
	ld [wMenuCursorBuffer], a
	ld a, [wGearPocketScrollPosition]
...
PackGFXPointers:
	...
	dw PackGFX + (15 tiles) * 0 ; GEAR_POCKET
