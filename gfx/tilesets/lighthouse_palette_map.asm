	...
	tilepal 1, GREEN, GREEN, ROOF, BROWN, RED, WATER, WATER, RED
	tilepal 1, RED, RED, RED, WATER, RED, RED, RED, RED
	tilepal 1, GREEN, GREEN, WATER, BROWN, RED, WATER, WATER, GRAY
	tilepal 1, GRAY, GRAY, GRAY, BROWN, RED, ROOF, GRAY, GRAY
	tilepal 1, BROWN, BROWN, WATER, WATER, RED, RED, BROWN, GRAY
	tilepal 1, GRAY, GRAY, GRAY, BROWN, BROWN, ROOF, BROWN, WATER
	tilepal 1, BROWN, BROWN, ROOF, ROOF, BROWN, BROWN, GRAY, GRAY
