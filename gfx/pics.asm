...
GogoFrontpic:    INCBIN "gfx/pokemon/gogo/front.animated.2bpp.lz"
TaurosFrontpic:      INCBIN "gfx/pokemon/tauros/front.animated.2bpp.lz"
PeritopFrontpic:    INCBIN "gfx/pokemon/peritop/front.animated.2bpp.lz"
...
LaketoiseFrontpic:   INCBIN "gfx/pokemon/laketoise/front.animated.2bpp.lz"
...
KettelderFrontpic:    INCBIN "gfx/pokemon/kettelder/front.animated.2bpp.lz"
...
FijiFrontpic:      INCBIN "gfx/pokemon/fiji/front.animated.2bpp.lz"
ArbokFrontpic:       INCBIN "gfx/pokemon/arbok/front.animated.2bpp.lz"
RainerFrontpic:      INCBIN "gfx/pokemon/rainer/front.animated.2bpp.lz"
PrismanFrontpic:   INCBIN "gfx/pokemon/prisman/front.animated.2bpp.lz"
...
AnimustFrontpic:  INCBIN "gfx/pokemon/animust/front.animated.2bpp.lz"
...
ComettonBackpic:      INCBIN "gfx/pokemon/cometton/back.2bpp.lz"
...
DrachillesFrontpic:  INCBIN "gfx/pokemon/drachilles/front.animated.2bpp.lz"
PyreapFrontpic:     INCBIN "gfx/pokemon/pyreap/front.animated.2bpp.lz"
...
PandoughFrontpic:    INCBIN "gfx/pokemon/pandough/front.animated.2bpp.lz"
...
MarinFrontpic:    INCBIN "gfx/pokemon/marin/front.animated.2bpp.lz"
AmpharosFrontpic:    INCBIN "gfx/pokemon/ampharos/front.animated.2bpp.lz"
MockereyFrontpic:    INCBIN "gfx/pokemon/mockerey/front.animated.2bpp.lz"
FlareonFrontpic:     INCBIN "gfx/pokemon/flareon/front.animated.2bpp.lz"
ChromniumFrontpic:   INCBIN "gfx/pokemon/chromnium/front.animated.2bpp.lz"
...
ComettonFrontpic:     INCBIN "gfx/pokemon/cometton/front.animated.2bpp.lz"
...
AnimustBackpic:   INCBIN "gfx/pokemon/animust/back.2bpp.lz"
...
MorayneFrontpic:     INCBIN "gfx/pokemon/morayne/front.animated.2bpp.lz"
EspeonFrontpic:      INCBIN "gfx/pokemon/espeon/front.animated.2bpp.lz"
XuXuFrontpic:         INCBIN "gfx/pokemon/xu_xu/front.animated.2bpp.lz"
...
RhinoxFrontpic:     INCBIN "gfx/pokemon/rhinox/front.animated.2bpp.lz"
ChampionPic:         INCBIN "gfx/trainers/champion.2bpp.lz"
CannonbaFrontpic:     INCBIN "gfx/pokemon/cannonba/front.animated.2bpp.lz"
MagikarpFrontpic:    INCBIN "gfx/pokemon/magikarp/front.animated.2bpp.lz"
EnkoFrontpic:  INCBIN "gfx/pokemon/enko/front.animated.2bpp.lz"
...
GritespecFrontpic:    INCBIN "gfx/pokemon/gritespec/front.animated.2bpp.lz"
...
SuikoFrontpic:    INCBIN "gfx/pokemon/suiko/front.animated.2bpp.lz"
...
BiggrfellaBackpic:   INCBIN "gfx/pokemon/biggrfella/back.2bpp.lz"
...
DoseetanFrontpic:     INCBIN "gfx/pokemon/doseetan/front.animated.2bpp.lz"
...
PeritopBackpic:     INCBIN "gfx/pokemon/peritop/back.2bpp.lz"
KiekeadaBackpic:      INCBIN "gfx/pokemon/kiekeada/back.2bpp.lz"
...
ChromniumBackpic:    INCBIN "gfx/pokemon/chromnium/back.2bpp.lz"
...
MarinBackpic:     INCBIN "gfx/pokemon/marin/back.2bpp.lz"
KettelderBackpic:     INCBIN "gfx/pokemon/kettelder/back.2bpp.lz"
ArcanineBackpic:     INCBIN "gfx/pokemon/arcanine/back.2bpp.lz"
FlareonBackpic:      INCBIN "gfx/pokemon/flareon/back.2bpp.lz"
MorayneBackpic:      INCBIN "gfx/pokemon/morayne/back.2bpp.lz"
StarmieBackpic:      INCBIN "gfx/pokemon/starmie/back.2bpp.lz"


SECTION "Pics 13", ROMX

DoseetanBackpic:      INCBIN "gfx/pokemon/doseetan/back.2bpp.lz"
...
MockereyBackpic:     INCBIN "gfx/pokemon/mockerey/back.2bpp.lz"
...
LaketoiseBackpic:    INCBIN "gfx/pokemon/laketoise/back.2bpp.lz"
...
PrismanBackpic:    INCBIN "gfx/pokemon/prisman/back.2bpp.lz"
...
PandoughBackpic:     INCBIN "gfx/pokemon/pandough/back.2bpp.lz"
VulpixBackpic:       INCBIN "gfx/pokemon/vulpix/back.2bpp.lz"
EkansBackpic:        INCBIN "gfx/pokemon/ekans/back.2bpp.lz"
PyreapBackpic:      INCBIN "gfx/pokemon/pyreap/back.2bpp.lz"
...
UnluckyFrontpic:      INCBIN "gfx/pokemon/unlucky/front.animated.2bpp.lz"
...
RainerBackpic:       INCBIN "gfx/pokemon/rainer/back.2bpp.lz"
...
XuXuBackpic:          INCBIN "gfx/pokemon/xu_xu/back.2bpp.lz"
MachopBackpic:       INCBIN "gfx/pokemon/machop/back.2bpp.lz"
AbraBackpic:         INCBIN "gfx/pokemon/abra/back.2bpp.lz"
DrachillesBackpic:   INCBIN "gfx/pokemon/drachilles/back.2bpp.lz"
MaizearFrontpic:      INCBIN "gfx/pokemon/maizear/front.animated.2bpp.lz"
DugtrioBackpic:      INCBIN "gfx/pokemon/dugtrio/back.2bpp.lz"
WeepinbellBackpic:   INCBIN "gfx/pokemon/weepinbell/back.2bpp.lz"
GritespecBackpic:     INCBIN "gfx/pokemon/gritespec/back.2bpp.lz"
...
SilkornFrontpic:      INCBIN "gfx/pokemon/silkorn/front.animated.2bpp.lz"
...
RhinoxBackpic:      INCBIN "gfx/pokemon/rhinox/back.2bpp.lz"
...
UnluckyBackpic:       INCBIN "gfx/pokemon/unlucky/back.2bpp.lz"
...
BigfellaFrontpic:     INCBIN "gfx/pokemon/bigfella/front.animated.2bpp.lz"
...
LilfellaFrontpic:    INCBIN "gfx/pokemon/lilfella/front.animated.2bpp.lz"
...
CannonbaBackpic:      INCBIN "gfx/pokemon/cannonba/back.2bpp.lz"
...
FijiBackpic:       INCBIN "gfx/pokemon/fiji/back.2bpp.lz"
...
RaikoBackpic:    INCBIN "gfx/pokemon/raiko/back.2bpp.lz"
...
LilfellaBackpic:     INCBIN "gfx/pokemon/lilfella/back.2bpp.lz"
...
MaizearBackpic:       INCBIN "gfx/pokemon/maizear/back.2bpp.lz"
...
GogoBackpic:     INCBIN "gfx/pokemon/gogo/back.2bpp.lz"
DittoBackpic:        INCBIN "gfx/pokemon/ditto/back.2bpp.lz"
SilkornBackpic:       INCBIN "gfx/pokemon/silkorn/back.2bpp.lz"
CleffaBackpic:       INCBIN "gfx/pokemon/cleffa/back.2bpp.lz"
DrowzeeBackpic:      INCBIN "gfx/pokemon/drowzee/back.2bpp.lz"
TriantulaBackpic:       INCBIN "gfx/pokemon/triantula/back.2bpp.lz"
...
BigfellaBackpic:      INCBIN "gfx/pokemon/bigfella/back.2bpp.lz"
...
SuikoBackpic:     INCBIN "gfx/pokemon/suiko/back.2bpp.lz"
...
RaikoFrontpic:   INCBIN "gfx/pokemon/raiko/front.animated.2bpp.lz"
FeraligatrFrontpic:  INCBIN "gfx/pokemon/feraligatr/front.animated.2bpp.lz"
TriantulaFrontpic:      INCBIN "gfx/pokemon/triantula/front.animated.2bpp.lz"
...
KiekeadaFrontpic:     INCBIN "gfx/pokemon/kiekeada/front.animated.2bpp.lz"
...
BiggrfellaFrontpic:  INCBIN "gfx/pokemon/biggrfella/front.animated.2bpp.lz"
...
UnownVBackpic:
UnownSBackpic:
INCBIN "gfx/pokemon/missingno/back.2bpp.lz"
...
EnkoBackpic:   INCBIN "gfx/pokemon/enko/back.2bpp.lz"
