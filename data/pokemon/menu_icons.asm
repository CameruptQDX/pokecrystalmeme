...
MonMenuIcons:
	db ICON_FOX   ; RAIKO
	db ICON_FOX   ; RAI
	db ICON_CLEFAIRY   ; PERITOP
	db ICON_FOX  ; ENKO
	db ICON_FOX  ; EN
	db ICON_BUG      ; PRISMAN
	db ICON_FOX    ; SUIKO
	db ICON_FOX    ; SUI
	db ICON_SQUIRTLE    ; LAKETOISE
	db ICON_DIGLETT ; LILFELLA
	db ICON_DIGLETT ; BIGFELLA
	db ICON_DIGLETT        ; BIGGRFELLA
	db ICON_ODDISH ; SILKORN
	db ICON_ODDISH ; MAIZEAR
	db ICON_ODDISH         ; KETTELDER
	db ICON_BIRD        ; PIDGEY
	...
	db ICON_BLOB         ; GRITESPEC
	db ICON_GHOST         ; MOCKEREY
	...
	db ICON_MONSTER     ; ANIMUST
	db ICON_FISH        ; HORSEA
	db ICON_FISH        ; SEADRA
	db ICON_FISH        ; MORAYNE
	db ICON_EQUINE        ; PYREAP
	...
	db ICON_CLEFAIRY       ; DOSEETAN
	db ICON_CLEFAIRY       ; COMETTON
	db ICON_GHOST       ; UNLUCKY
	db ICON_LAPRAS       ; MARIN
	db ICON_BIGMON        ; DRACHILLES
	...
	db ICON_GHOST       ; DOOMSDAY
	db ICON_MONSTER     ; OMEGA ZERO
