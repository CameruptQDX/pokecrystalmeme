	...
	tilecoll HOP_DOWN_RIGHT, WALL, WALL, WALL ; 88
	tilecoll FLOOR, FLOOR, FLOOR, WALL ; 89
	tilecoll HEADBUTT_TREE, HEADBUTT_TREE, FLOOR, WALL ; 8a
	tilecoll FLOOR, FLOOR, HEADBUTT_TREE, HEADBUTT_TREE ; 8b
	tilecoll FLOOR, FLOOR, WATER, WATER ; 8c
	tilecoll FLOOR, FLOOR, FLOOR, FLOOR ; 8d
	tilecoll HEADBUTT_TREE, HEADBUTT_TREE, FLOOR, HEADBUTT_TREE ; 8e
	tilecoll FLOOR, HEADBUTT_TREE, FLOOR, HEADBUTT_TREE ; 8f
	tilecoll HEADBUTT_TREE, HEADBUTT_TREE, HEADBUTT_TREE, FLOOR ; 90
	tilecoll HEADBUTT_TREE, FLOOR, HEADBUTT_TREE, FLOOR ; 91
	tilecoll FLOOR, FLOOR, WALL, FLOOR ; 92
	tilecoll WALL, WALL, WALL, WALL ; 93
	tilecoll WALL, WALL, UP_WALL, UP_WALL ; 94
	...
	tilecoll TALL_GRASS, FLOOR, FLOOR, TALL_GRASS ; 9d
	tilecoll WATER, WATER, WATER, WATER ; 9e
	tilecoll WALL, WALL, WALL, WALL ; 9f
	tilecoll WALL, HOP_DOWN_LEFT, WALL, WALL ; a0
	tilecoll HOP_DOWN, HOP_DOWN, WALL, WALL ; a1
	tilecoll WALL, HOP_LEFT, WALL, HOP_LEFT ; a2
	tilecoll WALL, FLOOR, WALL, FLOOR ; a3
	tilecoll WALL, FLOOR, FLOOR, FLOOR ; a4
	tilecoll WALL, WATER, FLOOR, WATER ; a5
	tilecoll WATER, FLOOR, WATER, FLOOR ; a6
