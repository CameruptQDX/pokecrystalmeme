...
; entries correspond to deco constants
	...
	decoration DECO_DOLL,    RAIKO,      SET_UP_DOLL,       EVENT_DECO_BULBASAUR_DOLL,       SPRITE_BULBASAUR ; WHY DO THESE NEED TO REFERENCE MON CONSTANTS?
	decoration DECO_DOLL,    ENKO,     SET_UP_DOLL,       EVENT_DECO_CHARMANDER_DOLL,      SPRITE_CHARMANDER
	decoration DECO_DOLL,    SUIKO,       SET_UP_DOLL,       EVENT_DECO_SQUIRTLE_DOLL,        SPRITE_SQUIRTLE
	...
	decoration DECO_DOLL,    VENONAT,         SET_UP_DOLL,       EVENT_DECO_WEEDLE_DOLL,          SPRITE_WEEDLE
	decoration DECO_DOLL,    MISSINGNO,          SET_UP_DOLL,       EVENT_DECO_UNOWN_DOLL,           SPRITE_UNOWN
