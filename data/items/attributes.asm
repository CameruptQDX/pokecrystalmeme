...
; ULTRA_BALL
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE ; cheaper balls
; BRIGHTPOWDER
	item_attribute 10, HELD_BRIGHTPOWDER, 20, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; GREAT_BALL
	item_attribute 400, HELD_NONE, 0, CANT_SELECT, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE ; cheaper balls
; POKE_BALL
	item_attribute 100, HELD_NONE, 0, CANT_SELECT, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE ; cheaper balls
; GOTCHA_CHARM
	item_attribute 100, HELD_CATCH_CHANCE, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BICYCLE
...
; HYPER_POTION
	item_attribute 1500, HELD_NONE, 120, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY ; heals less, costs more
; SUPER_POTION
	item_attribute 900, HELD_NONE, 40, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY ; ^
; POTION
	item_attribute 400, HELD_NONE, 20, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY ; costs more
; ESCAPE_ROPE
...
; WATER_STONE
	item_attribute 2100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; LIECHI_BERRY
	item_attribute 10, HELD_ATTACK_UP, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; HP_UP
...
; X_ACCURACY
	item_attribute 1500, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_CLOSE ; price increase
; LEAF_STONE
	item_attribute 2100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; METAL_POWDER
...
; FULL_HEAL
	item_attribute 1500, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY ; far more expensive
; REVIVE
	item_attribute 1500, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE ; revives no longer usable in battle
; MAX_REVIVE
...
; GANLON_BERRY
	item_attribute 10, HELD_DEFENSE_UP, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; FRESH_WATER
	item_attribute 350, HELD_NONE, 25, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY ; heals less, costs more
; SODA_POP
	item_attribute 500, HELD_NONE, 40, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY ; heals less, costs more
; LEMONADE
	item_attribute 900, HELD_NONE, 60, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY ; heals less, costs more
; X_ATTACK
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_CLOSE ; price increase
; SALAC_BERRY
	item_attribute 10, HELD_SPEED_UP, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; X_DEFEND
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_CLOSE ; price increase
; X_SPEED
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_CLOSE ; price
; X_SPECIAL
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_CLOSE ; price
; COIN_CASE
...
; ITEMFINDER
	item_attribute 0, HELD_NONE, 0, CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; PETAYA_BERRY
	item_attribute 10, HELD_SP_ATTACK_UP, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; EXP_SHARE
...
; SILVER_WING
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MOOMOO_MILK
	item_attribute 500, HELD_NONE, 80, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY ; heals less
; QUICK_CLAW
...
; BLU_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; APICOT_BERRY
	item_attribute 10, HELD_SP_DEFENSE_UP, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; AMULET_COIN
...
; BLK_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; STRIB_BERRY
	item_attribute 10, HELD_EVASION_UP, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; PNK_APRICORN
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLACKGLASSES
...
; RAGECANDYBAR
	item_attribute 300, HELD_NONE, 40, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY ; heals as much as a super potion now
; GS_BALL
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLUE_CARD
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
...
; NUTPEA_BERRY
	item_attribute 10, HELD_ACCURACY_UP, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY
; ENERGYPOWDER
	item_attribute 700, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY ; price gouging
; ENERGY_ROOT
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY ; price gouging
; HEAL_POWDER
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_PARTY ; price gouging
; REVIVAL_HERB
	item_attribute 3000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE ; revives no longer usable in battle
; HARD_STONE
	item_attribute 100, HELD_ROCK_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LUCKY_EGG
	item_attribute 2000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE ; turned into joy pendant
; CARD_KEY
...
; SACRED_ASH
	item_attribute $9999, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; HEAVY_BALL
...
; SUN_STONE
	item_attribute 2100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; QUARTZ PRISM (POLKADOT_BOW)
	item_attribute 2100, HELD_CRYSTAL_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; COMET SHARD
	item_attribute 2100, HELD_STAR_BOOST, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; UP_GRADE
	item_attribute 2100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; BERRY
