...
FalknerGroup:
	...
	db 12, DODUO
		...
		db BERRY
		db PECK, FURY_ATTACK, MUD_SLAP, GROWL
	db -1 ; end
...
BugsyGroup:
	...
	db 17, SANDSHREW
		...
		dw $0100, $0100, $0100, $0100, $0100
		db BERRY
		db FURY_CUTTER, SAND_ATTACK, MAGNITUDE, NO_MOVE
	db 18, YANMA
		db PERFECT_DV, PERFECT_DV
		dw $0100, $0100, $0100, $0100, $0100
		db NO_ITEM
		db DOUBLE_TEAM, FORESIGHT, QUICK_ATTACK, NO_MOVE
	db 19, GLIGAR
		db PERFECT_DV, PERFECT_DV
		dw $0100, $0100, $0100, $0100, $0100
		db FURY_CUTTER, FAINT_ATTACK, SAND_ATTACK, POISON_STING
		db 
	db -1 ; end
...
ChuckGroup:
	...
	db 27, PRIMEAPE,   LEER, TACKLE, KARATE_CHOP, FURY_SWIPES
...
Rival1Group:
	...
	db 17, PHANPY
		db PERFECT_DV, PERFECT_DV
		dw $0110, $0110, $0110, $0110, $0110
		db BERRY_JUICE
		db FLAIL, ROLLOUT, ENDURE, DEFENSE_CURL
	db 18, STARYU
		db PERFECT_DV, PERFECT_DV
		dw $0110, $0110, $0110, $0110, $0110
		db NO_ITEM
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, CROCONAW,   LEER, TACKLE, WATER_GUN, BITE
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, FERALIGATR, TACKLE, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, FERALIGATR, TACKLE, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
...
ChampionGroup:
	...
	db 46, MISSINGNO, WING_ATTACK, ANCIENTPOWER, ROCK_SLIDE, HYPER_BEAM
	db 46, MISSINGNO,  FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
...
BrockGroup:
	...
	db 42, MISSINGNO,    BITE, SURF, PROTECT, SPIKE_CANNON
	db 44, ONIX,       TACKLE, ROCK_SLIDE, TACKLE, SANDSTORM
	db 42, MISSINGNO,   SLASH, SURF, ENDURE, GIGA_DRAIN
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 26, MISSINGNO, EMBER, SMOKESCREEN, TACKLE, SCARY_FACE
	db 26, MISSINGNO,   TACKLE, WATER_GUN, BITE, CURSE
	db 26, MISSINGNO,  LEECH_SEED, POISONPOWDER, SLEEP_POWDER, RAZOR_LEAF
	db -1 ; end
	...
	db 35, KINGLER,    BUBBLEBEAM, STOMP, TACKLE, PROTECT
	...
	db 39, KINGLER,    KINGS_ROCK,   SURF, STOMP, TACKLE, BLIZZARD
	...
	db 32, KINGLER,    BUBBLEBEAM, STOMP, TACKLE, PROTECT
	...
	db 27, MISSINGNO, EMBER, SMOKESCREEN, TACKLE, SCARY_FACE
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 32, MISSINGNO,  BITE, CURSE, SURF, RAIN_DANCE
	db -1 ; end
	...
	db 32, MISSINGNO,  GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 32, MISSINGNO,    GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
	db 32, MISSINGNO,   BODY_SLAM, SLEEP_POWDER, RAZOR_LEAF, SWEET_SCENT
	db -1 ; end
	...
	db 25, MISSINGNO, CONFUSION, SLEEP_POWDER, WHIRLWIND, GUST
...
PokemaniacGroup:
	...
	db 12, MISSINGNO,  LICK, SUPERSONIC, CUT, NO_MOVE
	db -1 ; end
...
GruntMGroup:
	...
	db 17, DUNSPARCE
		dw $0080, $0080, $0080, $0080, $0080
		db NO_ITEM
		db ROLLOUT, PURSUIT, SCREECH, NO_MOVE
	db -1 ; end
...
BugCatcherGroup:
	...
	db 24, MISSINGNO, CONFUSION, POISONPOWDER, SUPERSONIC, WHIRLWIND
	db 24, MISSINGNO, CONFUSION, STUN_SPORE, SUPERSONIC, WHIRLWIND
	db 25, MISSINGNO,   FURY_ATTACK, FOCUS_ENERGY, TACKLE, TACKLE
	db 24, MISSINGNO, CONFUSION, SLEEP_POWDER, SUPERSONIC, WHIRLWIND
	db -1 ; end

	; BUG_CATCHER (16)
	db "WADE@", TRAINERTYPE_MOVES
	db 30, MISSINGNO, CONFUSION, POISONPOWDER, SUPERSONIC, GUST
	db 30, MISSINGNO, CONFUSION, STUN_SPORE, SUPERSONIC, GUST
	db 32, MISSINGNO,   FURY_ATTACK, PURSUIT, TACKLE, DOUBLE_TEAM
	db 34, MISSINGNO, PSYBEAM, SLEEP_POWDER, GUST, WHIRLWIND
	db -1 ; end
...
FisherGroup:
	...
	db 34, MISSINGNO,    SUPERSONIC, WATERFALL, FLAIL, FURY_ATTACK
	db 34, MISSINGNO,    SUPERSONIC, WATERFALL, FLAIL, FURY_ATTACK
	...
	db 39, MISSINGNO,    ENDURE, FLAIL, FURY_ATTACK, WATERFALL
	db -1 ; end

	; FISHER (25)
	db "TULLY@", TRAINERTYPE_MOVES
	db 34, MISSINGNO,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_ATTACK
	db 34, MISSINGNO,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_ATTACK
...
SwimmerFGroup:
	...
	db 22, MISSINGNO,    PECK, TAIL_WHIP, SUPERSONIC, HORN_ATTACK
	db -1 ; end
...
Rival2Group:
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, FERALIGATR, TACKLE, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
...
BlackbeltGroup:
	...
	db 33, ONIX,       TACKLE, ROCK_THROW, TOXIC, DIG
...
PsychicGroup:
	...
	db 13, ABRA,       TELEPORT, FLASH, NO_MOVE, NO_MOVE
	db 15, KADABRA,    TELEPORT, PSYCHIC, CONFUSION, NO_MOVE
	db -1 ; end
...
PicnickerGroup:
	...
	db 38, MISSINGNO,   SOLARBEAM, RAZOR_LEAF, HEADBUTT, MUD_SLAP
	db -1 ; end
...
RedGroup:
	...
	db 77, MISSINGNO,   SUNNY_DAY, GIGA_DRAIN, SYNTHESIS, SOLARBEAM
	db 77, MISSINGNO,  FLAMETHROWER, WING_ATTACK, SLASH, FIRE_SPIN
	db 77, MISSINGNO,  RAIN_DANCE, SURF, BLIZZARD, WHIRLPOOL
	db -1 ; end
