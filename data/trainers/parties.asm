...
CooltrainerMGroup:
	...
	db 26, MISSINGNO, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	...
	db 27, MISSINGNO, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db -1 ; end
...
BugCatcherGroup:
	...
	db 25, MISSINGNO,   FURY_ATTACK, FOCUS_ENERGY, TACKLE, RAGE
