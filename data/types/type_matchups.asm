TypeMatchups:
	...
	db ELECTRIC,  CRYSTAL,   NO_EFFECT
	db FIGHTING,  CRYSTAL,   SUPER_EFFECTIVE
	db PSYCHIC,   CRYSTAL,   NOT_VERY_EFFECTIVE
	db CRYSTAL,   CRYSTAL,   NOT_VERY_EFFECTIVE
	db CRYSTAL,   STEEL,     SUPER_EFFECTIVE
	db CRYSTAL,   DARK,      SUPER_EFFECTIVE
	db CRYSTAL,   FIRE,      NOT_VERY_EFFECTIVE
	db FIRE,      STAR,      NOT_VERY_EFFECTIVE
	db FIGHTING,  STAR,      NOT_VERY_EFFECTIVE
	db STAR,      GHOST,     SUPER_EFFECTIVE
	db STAR,      GROUND,    SUPER_EFFECTIVE
	db STAR,      DRAGON,    SUPER_EFFECTIVE
	db CRYSTAL,   STAR,      NOT_VERY_EFFECTIVE
	db STAR,      CRYSTAL,   NOT_VERY_EFFECTIVE
