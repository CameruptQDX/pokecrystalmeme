...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_COLLECTOR, CHIKORITA,  ONIX,       "ROLLY@@@@@@", $96, $66, BITTER_BERRY, 48926, "LYLE@@@@@@@", TRADE_GENDER_EITHER
	...
	npctrade TRADE_DIALOGSET_GIRL,      CHANSEY,    DRACHILLES, "AEROY@@@@@@", $96, $66, GOLD_BERRY,   26491, "KIM@@@@@@@@", TRADE_GENDER_EITHER
