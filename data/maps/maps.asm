...
MapGroup_Blackthorn:
	...
	map BlackthornCity, TILESET_SNOW, TOWN, BLACKTHORN_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Azalea:
	...
	map Route32, TILESET_JOHTO_MODERN, ROUTE, ROUTE_32, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH ; moved
	map RuinsOfAlphOutside, TILESET_JOHTO_MODERN, ROUTE, RUINS_OF_ALPH, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_POND ; moved
